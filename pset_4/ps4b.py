...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        for i in self.messege_text:
            if i in mapping_letter:
                shifted_msg += mapping_letter[i]
            else:
                shifted_msg += i
...
class PlaintextMessage(Message):
    ...
    def get_encryption_dict(self):
        ...
        '''
        encryption_dict_copy = self.build_shift_dict(shift)
